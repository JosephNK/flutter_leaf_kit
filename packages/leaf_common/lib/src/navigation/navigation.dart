...
enum NavigatorViewState { none, refresh, update, leave }

class NavigatorData {
  final NavigatorViewState state;
  final dynamic param;

  NavigatorData(this.state, {this.param});
}
...
class Navigation {
  ...
  // static pushScaleRoute(BuildContext context, {Widget widget}) {
