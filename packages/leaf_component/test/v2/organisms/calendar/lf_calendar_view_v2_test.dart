...
import 'package:flutter_leaf_component/src/v2/organisms/calendar/controller/lf_calendar_controller_v2.dart';
import 'package:flutter_leaf_component/src/v2/organisms/calendar/widget/lf_calendar_view_v2.dart';
...
void main() {
  group('LFCalendarViewV2', () {
    ...
    testWidgets('controller goToToday jumps to today', (tester) async {
      final controller = LFCalendarControllerV2();
      DateTime? selected;
