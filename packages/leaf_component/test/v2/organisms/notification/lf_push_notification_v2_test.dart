...
void main() {
  group('LFPushNotificationV2', () {
    ...
    testWidgets('shows notification without body', (tester) async {
      ...
      final notification = LFPushNotificationV2(title: 'Title Only');
    ...
    testWidgets('uses theme notification style', (tester) async {
      ...
      final theme = LFThemeData.light().copyWith(
        notificationTheme: const LFNotificationThemeData(
      ...
      final notification = LFPushNotificationV2(title: 'Themed');
    ...
    testWidgets('has semantics label', (tester) async {
      ...
      final notification = LFPushNotificationV2(title: 'Alert');
