...
class LFFlipAnimatedV2 extends StatefulWidget {
  final Widget front;
  final Widget rear;
  ...
  @override
  State<LFFlipAnimatedV2> createState() => _LFFlipAnimatedV2State();
}

class _LFFlipAnimatedV2State extends State<LFFlipAnimatedV2> {
  ...
  @override
  void didUpdateWidget(covariant LFFlipAnimatedV2 oldWidget) {
