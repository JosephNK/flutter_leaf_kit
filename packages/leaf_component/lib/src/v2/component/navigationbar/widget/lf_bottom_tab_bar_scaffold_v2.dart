...
import 'lf_bottom_tab_views_v2.dart';

/// A scaffold that combines [LFBottomTabBarV2] and [LFBottomTabViewsV2].
///
...
class LFBottomTabBarScaffoldV2 extends StatefulWidget {
  final LFBottomTabBarControllerV2 controller;
  final List<LFBottomTabItemV2> tabItems;
  final int selectedIndex;
  final List<int> deactivateIndexes;
  final LFBottomTabViewsBuilderV2 viewBuilder;
  ...
  const LFBottomTabBarScaffoldV2({
    super.key,
  ...
  @override
  State<LFBottomTabBarScaffoldV2> createState() =>
      _LFBottomTabBarScaffoldV2State();
}

class _LFBottomTabBarScaffoldV2State extends State<LFBottomTabBarScaffoldV2> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Semantics(
      ...
      child: Scaffold(
        ...
        body: LFBottomTabViewsV2(
          controller: widget.controller,
          builder: widget.viewBuilder,
        ),
        bottomNavigationBar: LFBottomTabBarV2(
          controller: widget.controller,
