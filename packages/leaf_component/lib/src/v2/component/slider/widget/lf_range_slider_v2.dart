...
class LFRangeSliderV2 extends StatefulWidget {
  ...
  @override
  State<LFRangeSliderV2> createState() => _LFRangeSliderV2State();
}

class _LFRangeSliderV2State extends State<LFRangeSliderV2> {
  RangeLabels? _labels;
