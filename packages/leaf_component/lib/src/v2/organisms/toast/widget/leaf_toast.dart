...
import '../type/leaf_toast_type.dart';
...
///   2. [LeafToastThemeData] from the nearest [LeafTheme]
...
class LeafToast {
  ...
  static Future<bool?> showToast(
    ...
    LeafToastType toastType = LeafToastType.lengthShort,
    LeafToastGravityType gravity = LeafToastGravityType.bottom,
  ...
  static ToastificationItem showNotification(
    ...
    required String message,
    String? description,
    LeafToastNotificationType? type,
    LeafToastNotificationStyle? style,
    Alignment? alignment,
    Duration? duration,
    Color? backgroundColor,
    TextStyle? textStyle,
    ...
    if (resolvedStyle == LeafToastNotificationStyle.simple) {
    ...
    return Toastification().show(
      ...
      description: description != null
          ...
          : null,
      type: type?.value ?? LeafToastNotificationType.success.value,
