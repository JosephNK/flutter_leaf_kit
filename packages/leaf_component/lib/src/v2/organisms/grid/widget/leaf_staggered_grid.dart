...
@immutable
class LeafStaggeredGrid extends StatelessWidget {
  ...
  final List<LeafStaggeredGridTile> children;
  ...
  const LeafStaggeredGrid({
    ...
    this.axisDirection,
    this.children = const <LeafStaggeredGridTile>[],
  });
...
@immutable
class LeafStaggeredGridTile extends StatelessWidget {
