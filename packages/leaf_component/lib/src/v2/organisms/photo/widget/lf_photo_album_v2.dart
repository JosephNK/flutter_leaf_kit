...
import '../mixin/lf_photo_album_request_v2.dart';
...
class LFPhotoAlbumV2 extends StatefulWidget {
  ...
  @override
  State<LFPhotoAlbumV2> createState() => _LFPhotoAlbumV2State();
}

class _LFPhotoAlbumV2State extends State<LFPhotoAlbumV2>
    with LFPhotoAlbumRequestV2 {
  ...
  @override
  void didUpdateWidget(covariant LFPhotoAlbumV2 oldWidget) {
...
class _AlbumTileState extends State<_AlbumTile> {
  ...
  Future<void> _loadThumbnail() async {
    ...
    final cached = LFImageLruCacheV2.getData(entity, widget.size.toInt());
    if (cached != null) {
    ...
    LFImageLruCacheV2.setData(entity, widget.size.toInt(), data);
