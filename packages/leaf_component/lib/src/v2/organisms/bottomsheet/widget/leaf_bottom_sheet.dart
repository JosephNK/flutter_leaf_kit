...
import '../model/leaf_bottom_sheet_item.dart';
...
///   2. [LeafBottomSheetThemeData] from the nearest [LeafTheme]
///   3. Global tokens ([LeafColors.primary], [LeafColors.onSurface])
class LeafBottomSheet {
  const LeafBottomSheet._();

  static void show<T>(
    BuildContext context, {
    required List<LeafBottomSheetItem<T>> items,
    LeafBottomSheetItem<T>? selectedItem,
    Color? activeColor,
    Color? inactiveColor,
    TextStyle? itemTextStyle,
    String? cancelText,
    ValueChanged<LeafBottomSheetItem<T>>? onTap,
