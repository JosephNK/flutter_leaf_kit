    ...
    return Semantics(
      ...
      child: LeafInkWell(
        ...
        child: Row(
          ...
          mainAxisSize: MainAxisSize.min,
          children: align == LeafRadioAlign.left
              ? children
