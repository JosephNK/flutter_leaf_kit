...
import '../../../atoms/badge/widget/leaf_badge.dart';
...
class LeafBottomTabBar extends StatelessWidget {
  ...
  final bool visible;
  final LeafBottomTabBarOnTap? onTap;
  final LeafBottomTabBarOnSelect? onSelect;

  const LeafBottomTabBar({
    super.key,
...
class _TabRow extends StatelessWidget {
  final List<LeafBottomTabItem> items;
                ...
                if (item.badgeCount > 0)
                  Positioned.fill(
                    child: Align(
                      ...
                      child: LeafBadge(text: item.badgeCount.toString()),
                    ),
                  ),
              ],
            ),
