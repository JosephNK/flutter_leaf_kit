...
/// Usage:
/// ```dart
/// final controller = LeafBottomTabBarController();
...
/// ```
class LeafBottomTabBarController extends ChangeNotifier {
  int _selectedIndex;
  int _previousIndex;
  ...
  List<LeafBottomTabItem> get tabItems => _tabItems;
  ...
  static List<LeafBottomTabItem> _rebuildItems(
    List<LeafBottomTabItem> items, {
    required int selectedIndex,
  }) {
