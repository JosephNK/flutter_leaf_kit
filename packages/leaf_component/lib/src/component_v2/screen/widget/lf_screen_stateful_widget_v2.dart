...
///
/// Subclass [LFScreenStateV2] and override getters to customise the scaffold
/// without touching the build pipeline.
mixin ScreenVariableV2 {
  bool get useSafeArea => true;
  SafeAreaInsetsV2 get safeAreaInsets => const SafeAreaInsetsV2.all();
...
abstract class LFScreenStatefulWidgetV2 extends StatefulWidget {
  final LFBottomTabIndexV2? index;

  const LFScreenStatefulWidgetV2({
    super.key,
    this.index,
  });
}
...
/// * No `LFComponentConfigure` – uses [LFTheme] tokens.
/// * `SafeAreaInsets` renamed to [SafeAreaInsetsV2] (immutable).
abstract class LFScreenStateV2<T extends LFScreenStatefulWidgetV2>
  ...
  void didTabSelected(BuildContext context, LFBottomTabIndexV2 index) {}
