...
class LeafColors {
  ...
  factory LeafColors.light() {
    return const LeafColors(
  ...
  static LeafColors lerp(LeafColors a, LeafColors b, double t) {
    return LeafColors(
