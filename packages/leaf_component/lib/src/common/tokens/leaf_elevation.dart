...
class LeafElevation {
  ...
  factory LeafElevation.defaults() {
    return const LeafElevation(
      none: 0.0,
      xs: 1.0,
      sm: 2.0,
      md: 4.0,
  ...
  static LeafElevation lerp(LeafElevation a, LeafElevation b, double t) {
    return LeafElevation(
