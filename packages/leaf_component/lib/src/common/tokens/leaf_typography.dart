...
class LeafTypography {
  ...
  factory LeafTypography.defaults() {
    return const LeafTypography(
  ...
  static LeafTypography lerp(LeafTypography a, LeafTypography b, double t) {
    return LeafTypography(
  ...
  bool operator ==(Object other) {
    ...
    return other is LeafTypography &&
